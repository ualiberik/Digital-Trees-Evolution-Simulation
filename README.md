...
## Author & Credit
**Credit:** concept and core rules adapted from foo52 (Simulife Hub) — see [video]. 
...
Thus, received energy is determined by formula: tree.energy += (rank * (position.y + 3)) * simulation.lightAmount;
